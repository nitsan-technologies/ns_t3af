...
/**
 * Default AI Features drawer label keys for {@see ExtensionSettingsScopeProviderInterface}.
 */
trait ExtensionSettingsScopeMessagesTrait
{
    public function getSaveSuccessMessageKey(): string
    {
        return 'module.aiFeatures.saveSuccessMessage';
    }
