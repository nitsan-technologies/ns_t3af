...
1. Activate the extension in :guilabel:`Admin Tools > Extensions`.
...
2. Search for ``ns_t3af`` (or **T3AF**), install and activate it.
3. Run **Analyze Database Structure**.
...
* ``ns_t3af`` is listed as active in :guilabel:`Admin Tools > Extensions`
